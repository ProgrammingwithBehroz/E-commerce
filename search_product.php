     ...
     <div class="row">
        <div class="col-md-10">
            ...
            <div class="row">
              <?php
                ...
                if(isset($_GET['search'])){ 
                    ...
                    $search_product = "SELECT * from products where product_name like '%{$name}%'";
                    $result_search = mysqli_query($conn,$search_product);
          ...
          ?>
                        ...
                        echo" <h5 class='text-center mt-5 text-danger'>No results match, no products found on this category</h5>";
                    }
